...
let NewStaffComponent = /** @class */ (() => {
    let NewStaffComponent = class NewStaffComponent {
        constructor(cnx, route, router, _location, toastService) {
            ...
            this.temp = [];
            this.isLoading = true;
            this.tempDateTime = { editStartDate: '', editStartTime: '', editEndDate: '', editEndTime: '' };
        ...
        ngOnInit() {
            ...
            this.cnx.get_dataWithParams('group', '?status=1').subscribe(myGroup => {
                this.group = myGroup;
            ...
            this.cnx.get_data('program').subscribe(myPrograms => {
        ...
        staffEdit() {
            ...
            this.cnx.get_dataID('staff', '?staffID=' + this.staffID).subscribe(myStaff => {
                this.staff = myStaff;
                this.fillMultiSelect(myStaff);
            });
            this.cnx.get_dataID('staff', '?staffSGId=' + this.staffID).subscribe(myStaffPermisions => {
        ...
        fillMultiSelect(myStaff) {
            this.cnx.get_dataWithParams('group', '?staffId=' + myStaff.staffID).subscribe(myGroups => {
            ...
            this.cnx.get_dataWithParams('program', '?staffID=' + myStaff.staffID).subscribe(myPrograms => {
        ...
        saveStaff() {
            ...
            this.cnx.add_dataWithParams('staff', '?staffDatajson=', this.staff).subscribe(myStaff => {
        ...
        saveService() {
            ...
            this.cnx.add_dataWithParams('staff', '?staffSecurityInfoJson=', this.staffPermisions).subscribe(resStaffPermisions => {
    ...
    __decorate([
        ViewChild('scheduleTable', { static: false })
    ], NewStaffComponent.prototype, "table", void 0);
    __decorate([
        ViewChild('contextForm', { static: false })
    ], NewStaffComponent.prototype, "contextForm", void 0);
    NewStaffComponent = __decorate([
        Component({
    ...
    return NewStaffComponent;
})();
export { NewStaffComponent };
//# sourceMappingURL=new-staff.component.js.map